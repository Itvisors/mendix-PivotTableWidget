...
], function (declare, _WidgetBase, domClass, domConstruct, lang, dojoNumber, dojoArray, dojoDateLocale) {
    "use strict";

    // Declare widget.
    return declare("PivotDataWidget.widget.PivotDataWidget", [ _WidgetBase ], {
        ...
        /**
         * Called by the Mendix runtime when the context object changes or is cleared
         *
         * @param obj           The context objectto use
...
require(["PivotDataWidget/widget/PivotDataWidget"], function () {
    "use strict";
});
